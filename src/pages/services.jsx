    ...
    return (
        <AppLayout>
            <div className='flex flex-col w-full min-h-screen bg-[#ECECEC] mt-20'>
                <div className='w-full h-full flex flex-col justify-center py-4 md:py-20 ] gap-10 '>
                    ...
                    <div className='p-10 max-w-[1400px] m-auto'>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 maz-w-[96%] md:max-w-[90%] m-auto">
